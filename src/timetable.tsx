    ...
    <div className="w-full h-screen relative">
      <div className="w-full h-16 bg-black sticky top-0 flex justify-center  items-center ">
        <div className="w-1/2 h-full bg-orange- flex items-center pl-8">
          <h1 className="text-white text-3xl">Invigilator</h1>
        </div>
        <div className="w-1/2 h-full bg-orange= flex justify-end py-2 pr-6 gap-x-4">
          <Button
            onClick={() => {
              handlePrint();
            }}
          ...
          <a href="https://exam-mgt-sodiq-js.vercel.app/">
            <Button
              onClick={() => {
                handlePrint();
              }}
              className="text-lg text-center bg-orange-300"
              placeholder={"print"}
            >
              Exam Officer
            </Button>
